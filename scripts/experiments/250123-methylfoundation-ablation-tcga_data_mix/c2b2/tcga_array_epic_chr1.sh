...
#SBATCH --job-name=w_tissue_embedder-tcga_mix_chr1-32xl40s
#SBATCH --output=outputs/w_tissue_embedder-tcga_mix_chr1-32xl40s.log
...
job_name=tcga_array_epic_chr1-32xl40s-c2b2


max_steps=47714 # 1 epoch, 390,874,949 / 256 / 32 = 47,714
scheduler_num_training_steps=47714
...
data_flagfile=src/configs/cfg/data/dataset/tcga_array_epic_chr1/tokenized_dataset.cfg
