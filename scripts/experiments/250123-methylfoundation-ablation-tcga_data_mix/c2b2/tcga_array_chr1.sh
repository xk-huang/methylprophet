...
job_name=tcga_array_chr1-32xl40s-c2b2


max_steps=33571 # 1 epoch, 275,018,849 / 256 / 32 = 33,571
scheduler_num_training_steps=33571
...
data_flagfile=src/configs/cfg/data/dataset/tcga_array_chr1/tokenized_dataset.cfg
