...
job_name=tcga_array_wgbs_chr1-32xl40s-c2b2


max_steps=41381 # 1 epoch, 339,001,121 / 256 / 32 = 41,381
scheduler_num_training_steps=41381
...
data_flagfile=src/configs/cfg/data/dataset/tcga_array_wgbs_chr1/tokenized_dataset.cfg
