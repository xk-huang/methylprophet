...
#SBATCH --job-name=wo_tissue_embedder-tcga_mix_chr1-32xl40s
#SBATCH --output=outputs/wo_tissue_embedder-tcga_mix_chr1-32xl40s.log
...
output_dir=outputs
exp_name=250122-methylfoundation-ablation-tissue_embedder
job_name=wo_tissue_embedder-tcga_mix_chr1-32xl40s-c2b2


max_steps=55524 # 1 epoch, 454,857,221 / 256 / 32 = 55,524
