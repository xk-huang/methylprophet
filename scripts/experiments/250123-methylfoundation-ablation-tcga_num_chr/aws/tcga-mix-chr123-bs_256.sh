...
job_name=tcga-mix-chr123-bs_256-32xl40s-aws


max_steps=131975 # 1 epoch, 1,081,141,048 / 256 / 32 = 131,975
scheduler_num_training_steps=131975
...
data_flagfile=src/configs/cfg/data/dataset/tcga_chr123/tokenized_dataset.cfg
