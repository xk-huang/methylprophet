...
job_name=encode_wgbs-bs_512-64xl40s-aws


max_steps=49071 # 1 epoch, 1,607,969,220 / 512 / 64 = 49,071
scheduler_num_training_steps=49071
...
gene_dim=24337  # NOTE: gene dim for ENCODE is 24337, not 25017
...
data_flagfile=src/configs/cfg/data/dataset/encode/tokenized_dataset.cfg
