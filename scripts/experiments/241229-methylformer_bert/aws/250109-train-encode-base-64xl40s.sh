...
job_name=241229-train-encode-base-64xl40s


max_steps=98172  # 1 epoch, 1608459072 / 256 / 64 = 98172
scheduler_num_training_steps=98172
...
data_flagfile=src/configs/cfg/data/dataset/encode/dataset.cfg
