...
#SBATCH --job-name=241230-ablation-lr_1e_4-0_02_epoch-6xl40
#SBATCH --output=outputs/241230-ablation-lr_1e_4-0_02_epoch-large-6xl40.sh.log
...
job_name=241230-ablation-lr_1e_4-0_02_epoch-large-6xl40
...
model=src/configs/models/methylformer_bert.py:large
