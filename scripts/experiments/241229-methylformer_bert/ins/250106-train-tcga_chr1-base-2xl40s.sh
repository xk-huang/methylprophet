...
#SBATCH --job-name=250106-train-tcga_chr1-base-2xl40s
#SBATCH --output=outputs/250106-train-tcga_chr1-base-2xl40s.sh.log
...
job_name=250106-train-tcga_chr1-base-6xl40


max_steps=59288968  # 1 epoch, 91,067,855,400 / 256 / 6 = 59,288,968
scheduler_num_training_steps=59288968
