...
#SBATCH --job-name=250110-train-tcga_chr1-base-half_data-b12_wi1024_mlp-12xl40s
#SBATCH --output=outputs/250110-train-tcga_chr1-base-half_data-b12_wi1024_mlp-12xl40s
...
max_steps=74111  # 1 epoch, 227,669,638 / 256 / 12 = 74,111
scheduler_num_training_steps=74111
...
train_shuffle=True
num_nbase=1000
train_epoch_size=227669638 # 455,339,277 / 2 
