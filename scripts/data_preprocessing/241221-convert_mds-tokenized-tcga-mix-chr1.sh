...
python scripts/tools/data_preprocessing/convert_parquet_to_mds.py \
    ...
    --output_dir data/mds_tokenized/241213-tcga-mix-chr1/train \
...
python scripts/tools/data_preprocessing/convert_parquet_to_mds.py \
    ...
    --output_dir data/mds_tokenized/241213-tcga-mix-chr1/val \
    --num_workers "${NUM_WORKERS}" \
    --remove_unused_columns \
    --filter_by_chr chr1 \
    --tokenize_sequence
...
python scripts/tools/data_preprocessing/convert_parquet_to_mds.py \
    ...
    --output_dir data/mds_tokenized/241213-tcga-mix-chr1/val_10_shards \
    --num_workers 10 \
    --remove_unused_columns \
    --filter_by_chr chr1 \
    --tokenize_sequence
...
python scripts/tools/data_preprocessing/convert_parquet_to_mds.py \
    ...
    --output_dir data/mds_tokenized/241213-tcga-mix-chr1/val_new_cpg \
    --num_workers "${NUM_WORKERS}" \
    --remove_unused_columns \
    --filter_by_chr chr1 \
    --tokenize_sequence
