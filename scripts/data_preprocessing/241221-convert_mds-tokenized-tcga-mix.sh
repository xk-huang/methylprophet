...
python scripts/tools/data_preprocessing/convert_parquet_to_mds.py \
    ...
    --output_dir data/mds_tokenized/241213-tcga-mix/train \
...
python scripts/tools/data_preprocessing/convert_parquet_to_mds.py \
    ...
    --output_dir data/mds_tokenized/241213-tcga-mix/val \
    --num_workers "${NUM_WORKERS}" \
    --remove_unused_columns \
    --tokenize_sequence
...
python scripts/tools/data_preprocessing/convert_parquet_to_mds.py \
    ...
    --output_dir data/mds_tokenized/241213-tcga-mix/val_10_shards \
    --num_workers 10 \
    --remove_unused_columns \
    --tokenize_sequence
...
python scripts/tools/data_preprocessing/convert_parquet_to_mds.py \
    ...
    --output_dir data/mds_tokenized/241213-tcga-mix/val_new_cpg \
    --num_workers "${NUM_WORKERS}" \
    --remove_unused_columns \
    --tokenize_sequence
