"""
Edit: use absl logging instead of mmengine logging
"""
...
def _get_scoped_trace_graph(
    ...
    module_list = (nn.parallel.distributed.DistributedDataParallel, nn.DataParallel)
...
class JitModelAnalysis:
    ...
    def unsupported_ops(self, module_name: str = "") -> typing.Counter[str]:
        ...
        if self._stats is None:
            raise RuntimeError("Analysis results should be computed " "before calling unsupported_ops()")
        module_name = self.canonical_module_name(module_name)
    ...
    def canonical_module_name(self, name: str) -> str:
        ...
        if name in self._aliases:
            ...
            raise KeyError("Requested module name is not among " "the descendants of the analyzed model.")
    ...
    def _analyze(self) -> "Statistics":
        ...
        stats = Statistics(counts=counts, unsupported_ops=unsupported_ops, uncalled_mods=uncalled_mods)
        self._stats = stats
