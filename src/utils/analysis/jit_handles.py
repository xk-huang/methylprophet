...
def generic_activation_jit(op_name: Optional[str] = None) -> Handle:
    ...
    def _generic_activation_jit(i: Any, outputs: List[Any]) -> Union[typing.Counter[str], int]:
...
def norm_flop_counter(affine_arg_index: int) -> Handle:
    ...
    def norm_flop_jit(inputs: List[Any], outputs: List[Any]) -> Union[int, Any]:
...
def batchnorm_flop_jit(inputs: List[Any], outputs: List[Any]) -> Union[int, Any]:
...
def elementwise_flop_counter(input_scale: float = 1, output_scale: float = 0) -> Handle:
    ...
    def elementwise_flop(inputs: List[Any], outputs: List[Any]) -> Union[int, Any]:
        ret = 0
        if input_scale != 0:
